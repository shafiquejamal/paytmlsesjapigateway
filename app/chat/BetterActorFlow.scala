...
object BetterActorFlow {
  ...
  def namedActorRef[In, Out](
      props: ActorRef => Props,
      bufferSize: Int = 16,
      overflowStrategy: OverflowStrategy = OverflowStrategy.dropNew,
      name: String)(implicit factory: ActorRefFactory, mat: Materializer): Flow[In, Out, _] =
    actorRef(props, bufferSize, overflowStrategy, Some(name))
